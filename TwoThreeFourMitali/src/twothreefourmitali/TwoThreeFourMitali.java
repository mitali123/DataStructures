 ...
 */
package twothreefourmitali;
import java.util.Comparator;
/**
 *
 * @author manja
 */
public class TwoThreeFourMitali<T> {

	//Global data
	protected final TwoThreeFourMitali<T> divorcedAndChildless = null;
	protected TwoThreeFourMitali children[] = new TwoThreeFourMitali[4];
	...
	protected TwoThreeFourMitali<T> 	parent;
...
//	}
	...
	public TwoThreeFourMitali(Comparator<T> ca) {
		numberOfElems = 0;
		c = ca;
	}
	...
	//Test if leaf
	public boolean leaf() {
		TwoThreeFourMitali<T> test = firstChild();
	...
	public void createEdge(int i, TwoThreeFourMitali node) {
		children[i] = node;
		if(node != divorcedAndChildless) node.parent = this;
	}

	// delete edge from this node, return it
	public TwoThreeFourMitali removeEdge(int i) {
		TwoThreeFourMitali tmp = getChild(i);
	...
	//Get parent
	public TwoThreeFourMitali parent() {
		return parent;
	}

	//Get first child
	public TwoThreeFourMitali firstChild() {
		return children[0];
	}
	//Get  last child
	public TwoThreeFourMitali lastChild() {
		return children[numberOfElems];
	}

	//Get child from node
	public TwoThreeFourMitali getChild(int i) {
		return children[i];
	}

	//get Children
	public TwoThreeFourMitali[] getChildren() {
		return children;
	}
